...
int main(int argc, char** argv) {
    ...
    char* list1; // list one consist of 2 to sqrtN, used to eliminate multiples
    ...
    // Finally until the last processes,it will be responsible for the remainders
    if (rank == size - 1) {
    ...
    if (rank == 0) {
        ...
        for (rank = 1; rank <= size - 1; rank++) {
            ...
            // Receive list2 from the processes 
